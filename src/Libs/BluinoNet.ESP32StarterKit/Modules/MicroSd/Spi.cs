...
namespace BluinoNet.Modules.FatFsNano
{
    static class Spi
    {
        ...
        public static void InitSpi()
        {
            ...
            {
                //DUMMY_CS_PIN_NUM
                var settings = new SpiConnectionSettings(MicroSdConfiguration.SPI_BUS_ID,MicroSdConfiguration.CS_PIN_NUM)   // The slave's select pin. Not used. CS is controlled by by GPIO pin
                {
                    Mode = SpiMode.Mode0,
